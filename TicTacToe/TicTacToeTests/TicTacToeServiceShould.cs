...
namespace TicTacToeTests
{
    public class TicTacToeServiceShould
    {
        ...
        [Fact]
        public void returns_O_as_winner_when_has_filled_in_second_column()
        {
            Play(0, 0);
            Play(0, 1);
            Play(1, 0);
            ...
            GameResult result = _ticTacToeService.Play(new Position(2, 1));

            Assert.Equal(GameResult.OWin, result);
        }

        [Fact]
        public void returns_X_as_winner_when_has_filled_in_diagonal()
        {
            Play(0, 0);
            Play(0, 1);
            Play(1, 1);
